                ...
                area: function () {
                    ...
                    if (img.width > winWidth && img.height > winHeight) {
                        if (img.width > img.height) {
                            //计算大屏幕宽度多少
                            var i = img.width - $(window).width();
                            //所占原来宽度的百分比
                            var x = i / img.width;
                            currentWidth = img.width = $(window).width() * 0.8;
                            currentHeigth = img.height = (img.height - img.height * x) * 0.8;
                        } else {
                            //计算大屏幕高度多少
                            var i = img.height - $(window).height();
                            //所占原来高度的百分比
                            var x = i / img.height;
                            currentHeigth = img.height = $(window).height() * 0.8;
                            currentWidth = img.width = (img.width - img.width * x) * 0.8;

                        }
                    }
                    else if (img.width > winWidth) {
                        //计算大屏幕宽度多少
                        var i = img.width-$(window).width() ;
                        //所占原来宽度的百分比
                        var x = i / img.width;
                        ...
                        currentHeigth = img.height;
                    }
                    var imgarea = [currentWidth,currentHeigth];
